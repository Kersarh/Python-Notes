...
finditer() Найти все подстроки совпадений с регулярным выражением
    и вернуть их в виде ИТЕРАТОРА
"""
print("-- match --")
...
p = re.compile(r"From\w+", re.IGNORECASE)
...
MULTILINE, M - Специальные символы ^ и $
               соответствуют началу и концу каждой строки

UNICODE, U - Делает \w, \W, \b, \B, \d, \D, \s, \S
