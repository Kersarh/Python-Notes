...
# Позиционная вставка:
# Позиция, в которую будут вставляться наши данные,
...
# в которой мы передаем данные, не имеет значения.
...
# \xhh — шестнадцатеричное значение символа.
# Например, \x6a соответствует символу j;
# \\ — обратный слэш.
# В Unicode-строках можно указать следующие специальные символы:
# \uxxxx — 16-битный символ Unicode.
# Например, \u043a соответствует русской букве к;
