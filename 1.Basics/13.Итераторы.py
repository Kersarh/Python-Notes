"""
Итератор (iterator) - это объект,
который возвращает свои элементы по одному за раз.
...
# Если хотите обойти элементы внутри вашего собственного класса,
# необходимо создать свой итератор.
