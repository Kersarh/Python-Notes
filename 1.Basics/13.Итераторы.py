...
# На основе такого функционала работает щикл for
...
# Такой класс должен содержать конструктор, принимающий на вход количество единиц и метод __next__().
# Чтобы с данным объектом мог работать цикл for, нужно в наш класс добавить метод __iter__(), который возвращает итератор.
