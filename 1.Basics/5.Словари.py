# Словарь (dict) - неупорядоченная структура данных, в которой элементы хранятся в виде ключ: значение.
...
# Можно воспользоваться try/except или  if. Что приводит к излишниму загромождению кода на простой операции.
...
# В if мы проверяем соответствует ли буква ключу словаря dic, и если да, то добавляем значение в строку ret_txt.
