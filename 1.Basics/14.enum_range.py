...
возвращает кортеж из индекса и значения текущего элемента
"""
arr2 = [1, 2, 3, 4, 5, 6]
...
"""
range(arg) может быть очень полезной,
если вам нужно выполнить действие определенное количество раз.
"""
arr = [1, 2, 3]
