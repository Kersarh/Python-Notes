...
main_group.add_argument('--version', '-V',
...
test_parser = subparsers.add_parser(
    'test', add_help=False, help='Запуск в режиме "test"', description='''Запуск программы с параметром test''')

# Будет использована стандертная справка
