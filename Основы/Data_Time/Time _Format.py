...
# %A — название дня недели в зависимости от настроек локали (например, "поне-дельник");
...
# возвращает стро-ковое представление даты в соответствии со строкой формата.
# Если второй па-раметр не указан, будет использоваться текущая дата и время.
...
# но в каче-стве параметра принимает количество секунд,
