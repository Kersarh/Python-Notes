...
# Возвращает объект struct_time, представ-ляющий
# универсальное время (UTC = ГРИНВИЧ).
# Если параметр не указан, то возвращается текущее время.
# Если параметр указан, то время будет соответст-вующим количеству секунд,
...
# указав его название или ин-декс внутри объекта:
print(d.tm_mon)
print(d[1])
...
# представ-ляющее количество секунд, прошедших с начала эпохи.
